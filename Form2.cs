...
namespace project_2
{
    public partial class Form2 : Form
    {
        ...
        void VeriGetir()
        {
            ...
            adapter = new MySqlDataAdapter("SELECT * FROM actor", conn);
            adapter.Fill(dt);
        ...
        {
            string sql = "INSERT INTO actor(Name,Surname,Birth_date,Gender,Country)" +
        ...
        {
            string sql = "UPDATE actor SET Name =@Name, Surname=@Surname," +
        ...
        private void dgwlist_CellEnter_1(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
